	...
	<table class="table">
		...
		<tr>
			<td colspan="4" align="center">
				...
				%> <input type="submit" class="btn btn-primary" value="수정"> <input type="button" class="btn btn-warning" value="삭제"
...
<h3>댓글목록</h3>
<ul id="list">
	<li style="display: none;" id="template"><span>댓글번호</span><b>댓글내용</b><span>유저아이디</span><span>작성일자</span><button>삭제</button></li>
</ul>
...
<script>
	...
	let writer = "<%=logId%>";
	console.log(bno);
	//bno = document.quarySelector('.boardNo').innerHTML;
