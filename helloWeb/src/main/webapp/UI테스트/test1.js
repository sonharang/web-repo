let targetAry =`[{"id":1,"first_name":"Tiff","last_name":"Revely","email":"trevely0@twitter.com","gender":"Female","salary":4129},
...
let members = JSON.parse(targetAry);
let result = members.filter(function(item,idx,ary) {
	return item.gender == 'Female' && item.salary > 4500;
})
console.log(result);